...
export const initialAppLanguage: AppLanguage =
  storedLang && isAppLanguage(storedLang) ? storedLang : "en";

const initialLanguage: I18nLanguage = langMap[initialAppLanguage];
